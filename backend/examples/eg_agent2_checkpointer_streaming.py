...
async def main():
    ...
    messages = [HumanMessage(content="What is the weather in Buenos Aires?")]

    async with AsyncMongoDBSaver.from_conn_string(conn_string=MONGODB_URI, db_name=DATABASE_NAME) as checkpointer:
