...
from agent_tools import get_data_from_csv_tool, vector_search_tool, generate_chain_of_thought_tool, process_data_tool, get_query_embedding_tool, process_vector_search_tool, persist_data_tool, get_llm_recommendation_tool
...
def create_workflow_graph(checkpointer=None):
    ...
    graph.add_edge("process_data", "embedding_node")
